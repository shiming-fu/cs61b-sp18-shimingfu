...
/**
 * Parses OSM XML files using an XML SAX parser. Used to construct the graph of
 * roads for
 ...
 * and the java
 * <a href="https://docs.oracle.com/javase/tutorial/jaxp/sax/parsing.html">SAX
 * parser tutorial</a>.
 *
 * You may find the CSCourseGraphDB and CSCourseGraphDBHandler examples useful.
 *
 * The idea here is that some external library is going to walk through the XML
 * file, and your override method tells Java what to do every time it gets to
 * the next
...
public class GraphBuildingHandler extends DefaultHandler {
     ...
     * vehicle
     * roads, but in practice we walk all over them with such impunity that we
     * forget cars can
     * actually drive on them.
     */
    private static final Set<String> ALLOWED_HIGHWAY_TYPES = new HashSet<>(
            Arrays.asList("motorway", "trunk", "primary", "secondary", "tertiary", "unclassified",
     ...
     *                   qualified names are
     *                   not available. This tells us which element we're looking
     *                   at.
